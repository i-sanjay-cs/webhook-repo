...
client = pymongo.MongoClient(f"mongodb+srv://toontown8268703019:{mongo_password}@web-hook.6y5og.mongodb.net/webhooks?retryWrites=true&w=majority&tls=true&tlsCAFile=/path/to/ca-certificate.crt", connectTimeoutMS=60000, socketTimeoutMS=60000)
